...
const replaceFileContents = (siteId, inventory) => fs.readFileSync(`./hbScript/build/${siteId}.min.js`).toString()
...
const generateBuild = file => {
    ...
    webpack({
        ...
        const inventory = fs.readFileSync(`./hbScript/inventory/${file}`).toString().replace(/\s/g, '');
