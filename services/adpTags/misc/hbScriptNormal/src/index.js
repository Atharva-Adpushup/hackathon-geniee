...
function sendDataToKeenIO(data) {
    ...
    imgEl.src = 'https://api.keen.io/3.0/projects/5922a50995cfc9addc2480dd/events/hb_normal?api_key=40C0401741E18AFC5F17B722BA6371984333FDD0C36101019C7C107C1E1334B4&data=' + encodedData;
...
googletag.cmd.push(function () {
    adpSlots['hb_div_1'].gSlot = googletag.defineSlot('/103512698/HB_25129_300x250_Test1', [300, 250], 'hb_div_1').addService(googletag.pubads());
    adpSlots['hb_div_2'].gSlot = googletag.defineSlot('/103512698/HB_25129_300x250_Test2', [300, 250], 'hb_div_2').addService(googletag.pubads());
    adpSlots['hb_div_3'].gSlot = googletag.defineSlot('/103512698/HB_25129_300x250_Test3', [300, 250], 'hb_div_3').addService(googletag.pubads());
