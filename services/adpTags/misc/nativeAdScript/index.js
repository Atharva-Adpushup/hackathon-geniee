...
function createAd(parent, image, title, description, btnText, btnLink, advertiserInfo, privacyInfo) {
    var adStyles = {
        ...
        text: "font-size: 12px; color: #414141; text-align: left; font-family:inherit; text-overflow: ellipsis; white-space: nowrap; overflow: hidden; margin: 0;",
        button: "background-color: #27ae60; line-height: 25px; max-height:30px; color: #fff; padding: 0 6px; font-size: 14px; border: 0; box-shadow: 0; cursor: pointer; font-family:inherit; border-radius: 4px; order: 3;",
        ...
        advertiser: "font-size: 10px; position: absolute; opacity: 0; -webkit-transition: -webkit-transform 0.3s, opacity 0.3s; -moz-transition: -moz-transform 0.3s, opacity 0.3s; transition: transform 0.3s, opacity 0.3s; -webkit-transform: translateY(-100%); -moz-transform: translateY(-100%); transform: translateY(-100%);"
...
//         adTagText.style.verticalAlign = '-webkit-baseline-middle';
    ...
    function processing() {
        ...
        return setContent(title, description, container, advertiserInfo).then(function() {
