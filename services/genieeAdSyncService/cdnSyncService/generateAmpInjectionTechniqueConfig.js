...
function getHbAdsApTag(siteId = 0, isActive = false, isAmpApliteEnabled = false) {
	const docKey = isAmpApliteEnabled ? docKeys.ampAplite : docKeys.apTag;
	return findAds(siteId, isActive, docKey);
}
