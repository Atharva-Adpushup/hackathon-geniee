...
function computeChosenVariation(moduleConfig) {
	...
	if (isForcedVariation) {
		chosenVariation = adp.$.extend(true, {}, moduleConfig.chosenVariation);
		return { selectedVariation: chosenVariation, config: adp.$.extend(true, {}, moduleConfig.data) };
	}
	...
	return getPersonalizedVariations(allVariations, isAutoOptimise).then(function(filteredVariations) {
		...
		var extendedConfig = adp.$.extend(true, {}, config);
