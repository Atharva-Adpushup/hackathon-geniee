...
import { updateGlobalURLAndUTMReportMetaData } from '../../../../actions/globalActions';
import { showNotification } from '../../../../actions/uiActions';
import URLAndUTMReport from '../../components/URLAndUTMReporting';

const mapStateToProps = (state, ownProps) => {
	const { sites, user } = state.global;

	const urlUTMReportingMeta = {
		fetched: true,
		data: {
			filter: {
				day_type: {
...
const mapDispatchToProps = dispatch => {
	const updateReportMetaData = updateGlobalURLAndUTMReportMetaData;
