    ...
    render() {
        ...
        return (
            <div className="hb-partner-options-creator">
                ...
                {
                    partners[selectedPartner] ? <PartnerOptions optionsIndex={index} setupIndex={setupIndex} optionsCallback={this.getOptions} partnerConfig={partners[selectedPartner]} selectedPartnerOptions={selectedPartnerOptions} /> : ''
                }
                <div className="text-right">
                    <button className="hb-remove" onClick={this.removePartnerOptionsCreator}>Remove</button>
                </div>
            </div>
        );
    }
