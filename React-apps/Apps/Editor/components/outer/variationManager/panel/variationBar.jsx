        ...
        <div style={{padding: "12px"}}>
            <Row>
                <Col className="pull-right" xs={2}>
                    {
                        !expanded
                        ? <Button className="btn-lightBg btn-expand btn-block" type="submit" onClick={onExpandVariationPanel.bind(null, '.variation-settings', {"property": "height", "value" : "100%"})}>Expand</Button>
                        : <Button className="btn-lightBg btn-compress btn-block" type="submit" onClick={onShrinkVariationPanel.bind(null, '.variation-settings', {"property": "height", "value" : "400"})}>Shrink</Button>                        
                    }
                </Col>
            </Row>
        </div>
