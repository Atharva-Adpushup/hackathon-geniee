...
module.exports = React.createClass({
    ...
    render: function() {
        ...
        return (<div className="containerButtonBar sm-pad">
            <Row>
                <Col xs={12}><Input type="text" onChange={this.handleChange} value={this.state.name} /></Col>
                <Col xs={12}><Button disabled={!allset} className="btn-lightBg btn-save btn-block" onClick={this.onSave} >Add New</Button></Col>
            </Row>

            <Row>
                <ListView items={this.props.blockList || ["http://test.com"]} removeHandler={this.onremove} addHandler={this.onActive} />
            </Row>
