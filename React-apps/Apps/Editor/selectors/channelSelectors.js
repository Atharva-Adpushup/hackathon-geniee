...
const getAllChannels = (state) => state.channelData.byIds,
	...
	getSampleUrl = createSelector([getAllChannels], (channelByIds) => (_.find(channelByIds, 'sampleUrl') ? _.find(channelByIds, 'sampleUrl').sampleUrl : false)),
...
export { getOpenChannels, getAllChannels, getActiveChannel, getActiveChannelId, getSampleUrl, getChannel, getClosedChannels };
