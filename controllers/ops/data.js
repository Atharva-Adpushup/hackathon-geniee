...
router
	.post('/cbDocEditor', function(req, res) {
		cbDocEditorModel.getResult(getDataFromRequest(req)).then(function(data) {
			res.json(data);
		}).catch(function(err) {
	...
	.post('/siteMap', function(req, res) {
		siteMapModel.getResult(getDataFromRequest(req)).then(function(data) {
			res.json(data);
		}).catch(function(err) {
			res.json({ 'error': err.toString() });
		});
	...
	.post('/getAutoAnalysisPageGroups', function(req, res) {
		getAutoAnalysisPageGroupsModel.getAutoAnalysisPageGroupsForSite(getDataFromRequest(req).siteId).then(function(data) {
			res.json(data);
		}).catch(function(err) {
			res.json({ 'error': err.toString() });
		});
	...
	.post('/elasticsearchSearcher', function(req, res) {
		elasticsearchSearcherModel.search(getDataFromRequest(req)).then(function(data) {
			res.json(data);
		}).catch(function(err) {
			res.json({ 'error': err.toString() });
		});
	...
	.post('/incontentSections', function(req, res) {
		...
		incontentSectionsModel.getIncontentSectionsPerChannel(JSON.parse(d.data).options).then(function(data) {
			res.json(data);
		}).catch(function(err) {
			res.json({ 'error': err.toString() });
		});
	...
	.post('/siteVitals', function(req, res) {
		siteVitalsModel.getResult(getDataFromRequest(req)).then(function(data) {
			res.json(data);
		}).catch(function(err) {
			res.json({ 'error': err.toString() });
		});
	...
	.post('/enableLogin', function(req, res) {
		userModel.getUserByEmail(getDataFromRequest(req).email).then(function(user) {
