...
module.exports = React.createClass({
	...
	render: function() {
		...
		if (this.state.showAdder) {
			return (<ApexIncontentAdder apexIncontentSection={this.state.apexIncontentSection} onUnloadCallback={this.toggleAdder}/>);
		}

		return (<div className="containerButtonBar sm-pad">
				<Row>
					<CustomInputTextWithButton respectNextPropsValue name="contentSelector" onValueChange={this.onContentSelectorChange.bind(null, 'contentSelectorChange')} onButtonClick={this.onContentSelectorChange.bind(null, 'contentSelectorSave')} layout="horizontal" buttonText="Save" value={this.state.contentSelector} labelText="Content Area Css Path" validationError="Enter a valid content area css path" />
				</Row>
				{
