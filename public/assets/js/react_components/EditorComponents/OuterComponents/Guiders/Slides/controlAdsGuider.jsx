...
module.exports = React.createClass({
    ...
    render: function () {
        return (
            <div>
                <p><b>Simply put, Control Ads are the ads you currently run on your website.</b></p>
                ...
                <p>See how useful they are? AdPushup cannot read them directly from your website, so we require you to transform your ad codes. Go ahead, and set them up!</p>
