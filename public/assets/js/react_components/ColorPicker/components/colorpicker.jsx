...
var Details = require('./details.react.jsx');
var Map = require('./map.react.jsx');
var Sample = require('./sample.react.jsx');
var Slider = require('./slider.react.jsx');
...
var ColorPicker = React.createClass({
  ...
  render: function () {
    ...
    return (
      /* jshint ignore:  start */
      <div style={this.props.style} className="colorpicker">
