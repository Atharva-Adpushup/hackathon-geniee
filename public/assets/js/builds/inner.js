...
/***/ function(module, exports, __webpack_require__) {
	...
	var _innerController = __webpack_require__(1);

	var _innerController2 = _interopRequireDefault(_innerController);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	(0, _innerController2.default)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _innerEditor = __webpack_require__(40);

	var _innerEditor2 = _interopRequireDefault(_innerEditor);

	var _domManager = __webpack_require__(203);

	var _messengerHelper = __webpack_require__(199);
	...
	var initEditor = function initEditor() {
		(0, _jquery2.default)(document).ready(function () {
			...
			(0, _messengerHelper.initMessageHandler)(store);
		});
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hbBoxInitState = { top: 0, left: 0, width: 0, height: 0 },
	    hbBox = function hbBox() {
		var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : hbBoxInitState;
		var action = arguments[1];

		switch (action.type) {
			case _commonConsts.hbBoxActions.SHOW_HB_BOX:
				return {
			...
			case _commonConsts.hbBoxActions.HIDE_HB_BOX:
	    ...
	    elmSelector = function elmSelector() {
		var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : adpElmInitState;
		var action = arguments[1];

		switch (action.type) {
			case _commonConsts.innerActions.SET_ELEMENT_SELECTOR_CORDS:
				return action.payload;

			case _commonConsts.innerActions.HIDE_ELEMENT_SELECTOR:
			case _commonConsts.innerVariationActions.UPDATE_VARIATION:
...
/***/ function(module, exports) {
	...
	exports.messengerCommands = messengerCommands;
	exports.siteModes = siteModes;
	...
	exports.hbBoxActions = hbBoxActions;
	exports.innerVariationActions = innerVariationActions;
	exports.innerActions = innerActions;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hbBoxContainer = __webpack_require__(41);

	var _hbBoxContainer2 = _interopRequireDefault(_hbBoxContainer);

	var _variationManagerContainer = __webpack_require__(43);

	var _variationManagerContainer2 = _interopRequireDefault(_variationManagerContainer);

	var _elementHighLighterContainer = __webpack_require__(205);

	var _elementHighLighterContainer2 = _interopRequireDefault(_elementHighLighterContainer);

	var _contentOverylayContainer = __webpack_require__(207);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _highlighterBox = __webpack_require__(42);

	var _highlighterBox2 = _interopRequireDefault(_highlighterBox);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var style = {
	    ...
	    HB = function HB(props) {
		return _react2.default.createElement('div', { className: '_APD_highlighter', style: Object.assign({}, style, { width: props.width, height: props.height, top: props.top, left: props.left }) });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _variationManger = __webpack_require__(44);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var variationManager = function (_React$Component) {
		_inherits(variationManager, _React$Component);

		function variationManager() {
			_classCallCheck(this, variationManager);

			return _possibleConstructorReturn(this, (variationManager.__proto__ || Object.getPrototypeOf(variationManager)).apply(this, arguments));
		}

		_createClass(variationManager, [{
			key: 'render',
			value: function render() {
				...
				sections = (0, _filter3.default)(props.sections, function (section) {
					return section.ads.length;
				});
				...
				return _react2.default.createElement(
					...
					sections.map(function (section) {
						return _react2.default.createElement(_section2.default, { key: section.id,
							...
							onXpathMiss: _this2.props.onXpathMiss,
							onAdClick: _this2.props.onAdClick
						});
					})
				);
			}
	...
	variationManager.propTypes = {
		...
		onXpathMiss: _react.PropTypes.func,
		onAdClick: _react.PropTypes.func
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayFilter = __webpack_require__(46),
	    baseFilter = __webpack_require__(47),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _max2 = __webpack_require__(154);
	...
	var _adBox = __webpack_require__(157);

	var _adBox2 = _interopRequireDefault(_adBox);
	...
	var Section = function (_React$Component) {
		...
		_createClass(Section, [{
			...
			value: function componentDidMount() {
				this.$target = (0, _jquery2.default)(this.props.xpath);
			...
			value: function getMaxDimensions() {
				...
				if (ads.length) {
					var ad = void 0;
					ad = (0, _max3.default)(ads, function (adObj) {
						return adObj.adObjWidth + (parseInt(adObj.css['margin-right'], 10) || 0) + (parseInt(adObj.css['margin-left'], 10) || 0);
					});
					d.width = ad.width + (parseInt(ad.css['margin-right'], 10) || 0) + (parseInt(ad.css['margin-left'], 10) || 0);
					ad = (0, _max3.default)(ads, function (adObj) {
						return adObj.adObjHeight + parseInt(adObj.css['margin-top'], 10) || 0 + (parseInt(adObj.css['margin-bottom'], 10) || 0);
					});
			...
			key: 'injectSection',
			value: function injectSection() {
				var _props = this.props,
				    operation = _props.operation,
				    xpath = _props.xpath,
				    $el = (0, _jquery2.default)('<div />');

				if (operation === 'Insert Before') {
					$el.insertBefore((0, _jquery2.default)(xpath));
				} else if (operation === 'Insert After') {
					$el.insertAfter((0, _jquery2.default)(xpath));
				} else if (operation === 'Append') {
					(0, _jquery2.default)(xpath).append($el);
				} else {
					(0, _jquery2.default)(xpath).prepend($el);
				}
				return $el;
			}
		}, {
			key: 'unMountSection',
			value: function unMountSection() {
				if (this.node) {
			...
			value: function renderSection() {
				...
				var css = Object.assign({}, { position: 'relative', clear: 'both', pointerEvents: 'none', width: '100%' }, { height: this.getMaxDimensions().height });
				this.$node.css(css);
	...
	Section.propTypes = {
		xpath: _react.PropTypes.string.isRequired,
		operation: _react.PropTypes.string.isRequired,
		id: _react.PropTypes.string.isRequired,
		ads: _react.PropTypes.array.isRequired,
		onXpathMiss: _react.PropTypes.func.isRequired,
		onAdClick: _react.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseExtremum = __webpack_require__(155),
	    baseGt = __webpack_require__(156),
	    identity = __webpack_require__(149);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _camelCase2 = __webpack_require__(158);
	...
	var highLighterClass = '_APD_highlighter',
	    adBoxSizeStyles = {
		background: '#eb575c !important',
		borderRadius: '3px !important',
		color: '#fff !important',
	    ...
	    AdBox = function AdBox(props) {
		var _props$ad = props.ad,
		    id = _props$ad.id,
		    width = _props$ad.width,
		    height = _props$ad.height,
		    css = _props$ad.css,
		    adBoxSizeContent = width + ' X ' + height,
		    clickHandler = function clickHandler(ev) {
			var $el = (0, _jquery2.default)(ev.target),
			    position = _utils2.default.dom.getElementBounds((0, _jquery2.default)(ev.target));
			props.clickHandler(id, position, _utils2.default.ui.getElementSelectorCords($el));
		};

		(0, _each3.default)(css, function (value, key) {
			delete css[key];
			css[(0, _camelCase3.default)(key)] = value;
		});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var asciiToArray = __webpack_require__(166),
	    hasUnicode = __webpack_require__(164),
	    unicodeToArray = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayReduce = __webpack_require__(169),
	    deburr = __webpack_require__(170),
	    words = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deburrLetter = __webpack_require__(171),
	    toString = __webpack_require__(140);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var basePropertyOf = __webpack_require__(172);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var asciiWords = __webpack_require__(174),
	    hasUnicodeWord = __webpack_require__(175),
	    toString = __webpack_require__(140),
	    unicodeWords = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isEqual2 = __webpack_require__(182);
	...
	var _rest2 = __webpack_require__(185);
	...
	var _uuid = __webpack_require__(197);
	...
	var randomStore = [],
		...
		existsInArray: function existsInArray(arr, toTest) {
			if (this.isValue(toTest) && arr.indexOf(toTest) !== -1) {
				return arr.indexOf(toTest);
			}
			var existsAt = -1;
			(0, _jquery2.default)(arr).each(function (index, elem) {
		...
		deepDiffMapper: {
			...
			map: function map(obj1, obj2, name) {
			...
			compareValues: function compareValues(value1, value2, name) {
				if (value1 === value2) {
		...
		bind: function bind(fn, self, args) {
			return (/** @type {!Function} */fn.call.apply(fn.bind, arguments)
			);
		},
		stringReverse: function stringReverse(s) {
			return s.split('').reverse().join('');
		},
		pluckMany: function pluckMany() {
			// get the property names to pluck
			var source = arguments[0];
			var propertiesToPluck = (0, _rest3.default)(arguments, 1);
			return (0, _map3.default)(source, function (item) {
				var obj = {};
				(0, _each3.default)(propertiesToPluck, function (property) {
					obj[property] = item[property];
				});
				return obj;
			});
		},
		removeDuplicate: function removeDuplicate(oldArr) {
			return (0, _filter3.default)(oldArr, function (element, index) {
				// tests if the element has a duplicate in the rest of the array
				for (index += 1; index < oldArr.length; index += 1) {
					if ((0, _isEqual3.default)(element, oldArr[index])) {
						return false;
					}
				}
				return true;
		...
		appendProtocolToUrl: function appendProtocolToUrl(url) {
			if (!/^https?:\/\//i.test(url)) {
				url = 'http://' + url;
			}
			return url;
	   ...
	   parser.host;     // => "example.com:3000"*/
		...
		sanitiseString: function sanitiseString(str) {
		...
		dom: {
			...
			getElementRelativeBounds: function getElementRelativeBounds(w) {
				var q = w.offset(),
				    p = q.left,
				    y = q.top,
				    x = w.outerWidth(!1),
			...
			getViewPort: function getViewPort() {
				var o = Math.max((0, _jquery2.default)(window).height(), (0, _jquery2.default)(document).height()),
				    n = Math.max((0, _jquery2.default)(window).width(), (0, _jquery2.default)(document).width());
				return {
					height: o,
					width: n
				};
		...
		ui: {
			getElementSelectorCords: function getElementSelectorCords($el) {
				var w = $el.offset().top,
				    p = $el.offset().left,
				    y = $el.outerHeight(),
				    o = $el.outerWidth(),
			...
			menuRenderPosition: function menuRenderPosition($target, context) {
				var contextTop = context.top,
				    ...
				    variationBarHeight = (0, _jquery2.default)('#variationManager').height();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rng = __webpack_require__(198);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _messenger = __webpack_require__(200);
	...
	var messenger = new _messenger2.default(),
	    sendMessage = function sendMessage(cmd, data) {
		switch (cmd) {
			case 'Hello':
	    ...
	    initMessageHandler = function initMessageHandler(_ref) {
		var dispatch = _ref.dispatch,
		...
		messenger.onMessage.add(function (cmd, data) {
			switch (cmd) {
				...
				case _commonConsts.messengerCommands.HIGHLIGHT_ELEMENT:
					dispatch((0, _actions.setElementSelectorCords)(_utils2.default.ui.getElementSelectorCords((0, _jquery2.default)(data.xpath))));
					dispatch((0, _actions.highlightElement)((0, _jquery2.default)(data.xpath)));
					break;

				case _commonConsts.messengerCommands.HIDE_ELEMENT_SELECTOR:
					dispatch((0, _actions.hideElementSelector)());
					break;

				case _commonConsts.messengerCommands.SELECT_ELEMENT:
					var $el = (0, _jquery2.default)(data.xpath),
					    vitals = (0, _domManager.getAdpVitals)($el);
					if (vitals) {
						sendMessage(_commonConsts.messengerCommands.SHOW_INSERT_CONTEXTMENU, {
							position: vitals.position,
							parents: vitals.parents,
							insertOptions: vitals.insertOptions
						});
						dispatch((0, _actions.setElementSelectorCords)(_utils2.default.ui.getElementSelectorCords($el)));
					}
					break;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function ($, Utils, Event) {
		var Messenger = function Messenger(target, origin) {
		...
		Messenger.prototype.isOriginValid = function (e) {
			return (/.adpushup.com/gi.test(e.origin) || this.alternateOrigin && Utils.urlInfo(e.origin).domain.indexOf(this.alternateOrigin) !== -1
			);
		};
		...
		return Messenger;
	}(_jquery2.default, _utils2.default, _event2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Event = function Event(isOneTime) {
		this.arguments = [];
	...
	Event.prototype.bind = function () {
		this.add(_utils2.default.bind.apply(this, arguments));
	};
	...
	Event.prototype.fire = function (a) {
		...
		_jquery2.default.each(this.subscribers, _utils2.default.bind(function (a, c) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.hideElementSelector = exports.hideHighlighter = exports.updateLayout = exports.setElementSelectorCords = exports.highlightElement = undefined;
	...
	var highlightElement = function highlightElement($el) {
		var el = $el.get(0);
		if (el.tagName === 'HTML' || el.tagName === 'BODY' || $el.hasClass('_ap_reject')) {
			return { type: _commonConsts.hbBoxActions.HIDE_HB_BOX };
		}
		return {
			type: _commonConsts.hbBoxActions.SHOW_HB_BOX,
			payload: _utils2.default.dom.getElementRelativeBounds($el)
		};
	},
	    ...
	    setElementSelectorCords = function setElementSelectorCords(cords) {
		return { type: _commonConsts.innerActions.SET_ELEMENT_SELECTOR_CORDS, payload: cords };
	};

	exports.highlightElement = highlightElement;
	exports.setElementSelectorCords = setElementSelectorCords;
	exports.updateLayout = updateLayout;
	exports.hideHighlighter = hideHighlighter;
	exports.hideElementSelector = hideElementSelector;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getAdpVitals = exports.initDomEvents = undefined;

	var _jquery = __webpack_require__(35);

	var _jquery2 = _interopRequireDefault(_jquery);

	var _cssSelectorator = __webpack_require__(204);
	...
	var selectorator = new _cssSelectorator2.default(),
	    events = 'click mouseup mouseleave mousedown mouseover',
	    getInsertOptions = function getInsertOptions(el) {
	    ...
	    getAdpVitals = function getAdpVitals($el) {
		var force = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

		if (!force && ($el.get(0).tagName === 'HTML' || $el.get(0).tagName === 'BODY' || $el.hasClass('_ap_reject') || $el.parents().hasClass('_ap_reject'))) {
			return false;
		}
		var xpath = selectorator.generate($el)[0],
		    insertOptions = getInsertOptions($el.get(0)),
		    position = _utils2.default.dom.getElementBounds($el),
		    parents = [{ xpath: xpath, tagName: $el.prop('tagName') }];

		$el.parents().each(function (index, parent) {
			if (parent.tagName !== 'HTML' && parent.tagName !== 'BODY') {
				parents.push({
					xpath: selectorator.generate((0, _jquery2.default)(parent))[0],
					tagName: parent.tagName
				});
			}
		});

		return { xpath: xpath, insertOptions: insertOptions, parents: parents, position: position };
	},
	    initDomEvents = function initDomEvents(_ref) {
		var dispatch = _ref.dispatch;

		(0, _jquery2.default)(document).ready(function () {
			(0, _messengerHelper.sendMessage)(_commonConsts.messengerCommands.CM_FRAMELOAD_SUCCESS, { channelId: window.ADP_CHANNEL_ID });
		});

		(0, _jquery2.default)('html').off().on(events, function (e) {
			...
			if (!isScriptedEvent) {
				...
				switch (e.type) {
					...
					case 'click':
						...
						if (vitals) {
							(0, _messengerHelper.sendMessage)(_commonConsts.messengerCommands.SHOW_INSERT_CONTEXTMENU, {
								position: vitals.position,
								parents: vitals.parents,
								insertOptions: vitals.insertOptions
							});
							dispatch((0, _actions.setElementSelectorCords)(_utils2.default.ui.getElementSelectorCords($target)));
						}
						break;
					default:
						return;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (_, $) {
		var escapeSelector = function escapeSelector(a) {
			return a.replace(/([\!\"\#\$\%\&'\(\)\*\+\,\.\/\:\;\<\=\>\?\@\[\\\]\^\`\{\|\}\~])/g, '\\$1');
		},
		    Selectorator = function Selectorator() {
		...
		Selectorator.prototype.generateSelector = function (a) {
			if (a.get(0) === document || typeof a.get(0).tagName === 'undefined') {
				return [''];
			}
		...
		Selectorator.prototype.generateSimple = function (a, b, c, d) {
			for (var e = this.getProperTagName(a), f, g = [], h = function h() {
				var b = a.attr('id');
				/** ********** Wordpress wild card selection **************/
				if (typeof b == 'string') {
					var ambiguity = b.match(new RegExp('(post-' + '|post_' + '|post-main-' + '|_ap_wp_content_start_' + '|_ap_wp_content_end_' + '|_ap_wp_content_top_' + '|_ap_wp_content_bottom_' + '|_ap_wp_post_left_' + '|_ap_wp_post_right_' + '|_ap_wp_post_top_' + '|_ap_wp_post_bottom_' + ')([0-9]*$)', 'i'));
					var pos = false;
				...
				return typeof b == 'string' && (b = b.trim(), b.length > 0) ? (f = '#' + escapeSelector(b), [f]) : null;
			}, j = function j() {
				if (e === 'body' || e === 'html') {
					return null;
				}
				for (var b = (a.attr('class') || '').replace(/\{.*\}/, '').split(/\s/), c = [], d = 0; d < b.length; d++) {
					var _f = b[d];
					if (_f) {
						if (this.INVALID_SELECTORS.classes.indexOf(_f) !== -1) {
							break;
						}
						_f = escapeSelector(_f);
						c.push('.' + _f);
					}
				}
				return c;
		...
		Selectorator.prototype.validate = function (a, b, c, d, e) {
			...
			if (d && f.length > 1 || !d && f.length == 0) {
				if (c && b.indexOf(':') === -1) {
					if (f = ' ', e && (f = ' > '), b = c + f + b, f = this.query(b), d && f.length > 1 || !d && f.length == 0) return null;
				} else return null;
			}
		...
		var escapeSelector = function escapeSelector(a) {
		    ...
		    Selectorator = function Selectorator() {
			this.INVALID_SELECTORS = { classes: ['}', 'ui-droppable', '_APD_highlighter'] };this.cachedResults = {};
		};Selectorator.prototype.generate = function (a) {
			this.cachedResults = {};return this.generateSelector(a);
		};Selectorator.prototype.generateSelector = function (a) {
			if (a.get(0) === document || typeof a.get(0).tagName === 'undefined') {
				return [''];
			}for (var b = [], c = [{ name: 'simple', fn: this.generateSimple }, { name: 'ancestor', fn: this.generateAncestor }, { name: 'recursive', fn: this.generateRecursive }], d = 0; d < c.length; d++) {
			...
			var el = $('#' + id);if (el.length > 1) {
				return false;
			}var elems = $('[id^=' + exp + ']');if (!elems || elems.length <= 0) {
				return false;
			}elems = elems.toArray();return elems.indexOf(el.get(0));
		};Selectorator.prototype.generateSimple = function (a, b, c, d) {
			for (var e = this.getProperTagName(a), f, g = [], h = function h() {
				var b = a.attr('id');if (typeof b == 'string') {
					var ambiguity = b.match(new RegExp('(post-' + '|post_' + '|post-main-' + '|_ap_wp_content_start_' + '|_ap_wp_content_end_' + '|_ap_wp_content_top_' + '|_ap_wp_content_bottom_' + '|_ap_wp_post_left_' + '|_ap_wp_post_right_' + '|_ap_wp_post_top_' + '|_ap_wp_post_bottom_' + ')([0-9]*$)', 'i'));var pos = false;if (ambiguity && ambiguity instanceof Array) {
						pos = this.convertToNthchild(ambiguity[1], b);
					}if (pos !== false && pos >= 0) {
						b = '[id^=' + ambiguity[1] + ']:eq(' + pos + ')'.toString();return f = b, [f];
					}
				}return typeof b == 'string' && (b = b.trim(), b.length > 0) ? (f = '#' + escapeSelector(b), [f]) : null;
			}, j = function j() {
				if (e === 'body' || e === 'html') {
					...
					var _f = b[d];if (_f) {
						if (this.INVALID_SELECTORS.classes.indexOf(_f) !== -1) {
							break;
						}_f = escapeSelector(_f);c.push('.' + _f);
					}
				}return c;
			}, l = [h, j, function () {
				var a = h.call(this);return a !== null ? [e + a[0]] : null;return a !== null ? [e + a[0]] : null;
			}, function () {
				var a = j.call(this);if (a !== null) {
					for (var _b = 0; _b < a.length; _b++) {
						a[_b] = e + a[_b];
					}
				}return a;
			}, function () {
				var b = a.attr('name');return b ? (f = e + '[name=\'' + b + '\']', [f]) : null;
			}], m = 0; m < l.length; m++) {
				if (g = l[m].call(this), g !== null && g.length > 0) {
					for (var k = 0; k < g.length; k++) {
						g[k] = this.validate(a, g[k], b, c, d);
					}this.clean(g, null);if (g.length > 0) return g;
				}
			}return [];
		};Selectorator.prototype.generateAncestor = function (a) {
			this.getProperTagName(a);for (var b = [], c = a.parents(), d = 0; d < c.length; d++) {
				var e = c[d],
				    f = !1;d == 0 && (f = !0);for (var e = this.generateSimple($(e), null, !1), g = 0; g < e.length; g++) {
					for (var h = this.generateSimple(a, e[g], !0, f), j = 0; j < h.length; j++) {
						b.push(h[j]);
					}
				}
			...
			var b = this.getProperTagName(a);b.indexOf(':') !== -1 && (b = '*');var c = a.parent(),
			    d = this.generateSelector(c)[0],
			    a = c.children(b).index(a),
			    b = b + ':eq(' + a + ')';d != '' && (b = d + ' > ' + b);return [b];
		};Selectorator.prototype.generateAllSelectors = function (a) {
			var selectors = [];selectors.push(this.generateSimple(a));selectors.push(this.generateAncestor(a));selectors.push(this.generateRecursive(a));selectors = _.flatten(selectors);return _.uniq(selectors);
		};Selectorator.prototype.getProperTagName = function (a) {
			return escapeSelector(a.get(0).tagName.toLowerCase());
		};Selectorator.prototype.validate = function (a, b, c, d, e) {
			var f = void 0;typeof d == 'undefined' && (d = !0);typeof e == 'undefined' && (e = !1);f = this.query(b);if (d && f.length > 1 || !d && f.length == 0) {
				if (c && b.indexOf(':') === -1) {
					if (f = ' ', e && (f = ' > '), b = c + f + b, f = this.query(b), d && f.length > 1 || !d && f.length == 0) return null;
				} else return null;
			}return [].indexOf.call(f, a.get(0)) !== -1 ? b : null;
			...
			var b = [],
			    c = 0,
			    d = a.length;a: for (; c < d; c++) {
				for (var e = 0, f = b.length; e < f; e++) {
					if (b[e] == a[c]) continue a;
				}b[b.length] = a[c];
			}return b;
		};Selectorator.prototype.query = function (a) {
			a in this.cachedResults || (this.cachedResults[a] = $(a));return this.cachedResults[a];
		};return Selectorator;
	}.placeholder, _jquery2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _elementHighLighter = __webpack_require__(206);
	...
	exports.default = (0, _reactRedux.connect)(function (_ref) {
		var elmSelector = _ref.elmSelector;
		return { cords: elmSelector };
	...
	var style = {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'div',
				null,
				_react2.default.createElement('div', { className: 'ovelayTop', style: Object.assign({}, style, cords.TOP) }),
				_react2.default.createElement('div', { className: 'ovelayLeft', style: Object.assign({}, style, cords.LEFT) }),
				_react2.default.createElement('div', { className: 'ovelayRight', style: Object.assign({}, style, cords.RIGHT) }),
				_react2.default.createElement('div', { className: 'ovelayBottom', style: Object.assign({}, style, cords.BOTTOM) })
			)
		);
	};

	ElementSelector.propTypes = {
		hbBox: _react.PropTypes.object
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _contentOverlay = __webpack_require__(208);
