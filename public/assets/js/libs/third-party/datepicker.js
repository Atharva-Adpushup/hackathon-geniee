...
(function($, undefined) {
    ...
    Datepicker.prototype = {
        ...
        show: function(e) {
            ...
            this.picker.show();
			this.picker.css({visibility:"visible",opacity:1});
        ...
        showMode: function(dir) {
            ...
            this.picker.find('>div').hide().filter('.datepicker-'+DPGlobal.modes[this.viewMode].clsName).css({'display':'block',visibility:"visible",opacity:"1"});
            this.updateNavArrows();
        }
    };
