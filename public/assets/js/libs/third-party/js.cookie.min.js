/**
 * Minified by jsDelivr using UglifyJS v2.8.22.
 * Original file: /npm/js-cookie@2.1.4/src/js.cookie.js
 * 
			...
			if ('undefined' != typeof document) {
				...
				for (var p = document.cookie ? document.cookie.split('; ') : [], d = 0; d < p.length; d++) {
					...
					try {
						...
						if (
							((l = o.read ? o.read(l, g) : o(l, g) || l.replace(/(%[0-9A-Z]{2})+/g, decodeURIComponent)),
							this.json)
						)
							try {
								l = JSON.parse(l);
...
//# sourceMappingURL=/sm/68a542fdcbd92f676c5004bee683d3400c3d1492337c3fd5a507e1d38f38c952.map
