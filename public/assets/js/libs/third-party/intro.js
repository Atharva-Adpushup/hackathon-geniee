...
(function (root, factory) {
    ...
    function _goToStep(step) {
        ...
        if (typeof (this._introItems) !== 'undefined' && this._options['enable'] == true) {
            _nextStep.call(this);
        }
    }
    ...
    function _nextStep() {
        ...
        if(Array.isArray(this._options.steps)){
            option = this._options.steps[this._currentStep];
            ...
            nextStep.element = document.querySelector(option.element);
            nextStep.position = option.position;
        }else{
            nextStep = this._introItems[this._currentStep];
        }
    ...
    function _placeTooltip(targetElement, tooltipLayer, arrowLayer, helperNumberLayer) {
        ...
        switch (currentTooltipPosition) {
            ...
            case 'top-middle-aligned':
                ...
                tooltipLayer.style.top = '-' + (tooltipOffset.height) + 'px';
                break;
            case 'right':
