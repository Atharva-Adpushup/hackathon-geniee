$(document).ready(function() {
	(function(w, d) {
		...
		var toolsModule = {
				...
				templates: {
					headerCode:
						"<script data-cfasync='false' type='text/javascript'>(function(w, d) { var s = d.createElement('script'); s.src = '//cdn.adpushup.com/__siteId__/adpushup.js'; s.type = 'text/javascript'; s.async = true; (d.getElementsByTagName('head')[0] || d.getElementsByTagName('body')[0]).appendChild(s); })(window, document);</script>"
				},
			...
			$body = $('body'),
			$popoversEl = $('[data-toggle=popover]');
