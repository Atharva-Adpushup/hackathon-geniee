...
const getLogParameters = (req, res, startTime, options) => {
    ...
    return { responseTime, method, url : originalUrl, ip, body, params, query, httpVersion, headers: options.logHeaders ? headers: undefined, statusCode, timeStamp, contentType, contentLength, userAgent, referrer: referrer ? referrer : null };
};
