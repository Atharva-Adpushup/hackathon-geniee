...
router
	.get('/fetchAds', (req, res) => {
		fetchAds(req, res, docKeys.apTag);
		...
		// 	.then(() => appBucket.getDoc(`${docKeys.apTag}${siteId}`))
		// 	.then(docWithCas =>
		// 		sendSuccessResponse(
		// 			{
	...
	.post(
		'/masterSave',
		(req, res) => masterSave(req, res, fn.adUpdateProcessing, fn.directDBUpdate, docKeys.apTag, 1)
	...
	.post(
		'/modifyAd',
		(req, res) => modifyAd(req, res, fn.adUpdateProcessing, fn.directDBUpdate, docKeys.apTag)
