const { SITE_METRICS_PERFORMANCE, STRING_DATE_FORMAT, PLATFORMS_KEYS } = require('../constants'),
...
module.exports = {
	getData: paramConfig => {
		const inputParameterCollection = [
			...
			dbQuery = `${SITE_METRICS_PERFORMANCE}`,
			databaseConfig = {
		...
		console.log(`Query for site metrics contribution between: ${paramConfig.fromDate} and ${paramConfig.toDate}`);
