const { GLOBAL_TOP_10_COUNTRIES_PERFORMANCE, STRING_DATE_FORMAT } = require('../constants'),
...
module.exports = {
	getData: paramConfig => {
		const inputParameterCollection = [
			...
			dbQuery = `${GLOBAL_TOP_10_COUNTRIES_PERFORMANCE}`,
			databaseConfig = {
		...
		console.log(`Query for global top 10 countries between: ${paramConfig.fromDate} and ${paramConfig.toDate}`);
