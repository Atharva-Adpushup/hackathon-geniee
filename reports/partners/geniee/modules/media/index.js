...
module.exports = {
	...
	updateMetrics: function(reportData) {
		...
		_.forOwn(reportData.pageGroups, function(pageGroupObj, pageGroupKey) {
			...
			computedData.media.pageRPM =
				Number((computedData.media.revenue / computedData.media.pageViews * 1000).toFixed(2)) || 0;

			computedData.media.tracked.pageCTR =
				Number((computedData.media.tracked.click / computedData.media.tracked.pageViews * 100).toFixed(2)) || 0;
