...
class ModalWrapper extends React.Component {
    ...
    saveCollection() {
        ...
        if(partnersNotValidated.length !== 0) {
            this.setState({ error: `Please fill all fields in following partners: ${partnersNotValidated.join(', ')}` });
            return;
        }
            ...
            <Modal show={isOpen} onHide={toggle} >
                ...
                <Modal.Body>
                    <form>
                        ...
                        <Row>
                            <Col sm={4} style={{ paddingRight: 0 }}>
                                <div style={{ fontSize: "1.4em", marginTop: "5px", fontWeight: 700 }} >Select Current Partner</div>
                            </Col>
                            <Col sm={8} >
                                <SelectBox 
                                ...
                                >
                                    { partnersSelected.map(size => <option key={size.value} value={size.value} >{ size.label }</option>) }
                                </SelectBox>
                            </Col>
                        </Row>
                        }
