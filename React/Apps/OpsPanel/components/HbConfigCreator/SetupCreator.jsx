...
class SetupCreator extends React.Component {
    constructor(props) {
        ...
        if(props.selectedSize) {
            const size = { width: Number(props.selectedSize.split('x')[0]), height: Number(props.selectedSize.split('x')[1]) },
        ...
        if(props.setupData) {
            ...
            setupData.forEach(data => {
                ...
                partnerOptionsCreators.push(<PartnerOptionsCreator selectedPartner={partner} selectedPartnerOptions={partnerOptions}/>);
            });
    ...
    addAnotherPartner() {
        this.setState({ partnerOptionsCreators: this.state.partnerOptionsCreators.concat(cloneElement(<PartnerOptionsCreator />)) });
    }
        ...
        return (
            <div className="col-sm-4">
                <div className="hb-setup-creator">
                    <button className="close hb-close-pane" onClick={this.removePartnerOptionsCreators}>x</button>
                    ...
                    <div className="partner-creator">
                        ...
                        {
                            this.state.selectedSize !== null ? <button className="mT-10 btn btn-lightBg btn-default" onClick={this.addAnotherPartner}>Add partner</button> : ''
                        }
                    </div>
                </div>
            </div>
