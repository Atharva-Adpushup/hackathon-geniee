    ...
    render: function() {
        ...
        return (
            <div className="containerButtonBar sm-pad">
                <CustomJsCodeEditor owner="channelIncontent" name="jsCodeEditor" value={this.state.value} onValueChange={this.onChange} />

                <Row className="butttonsRow">
                    <Col xs={6} md={6}>
                        <Button disabled={!this.state.manageValue} className="btn-lightBg btn-save" onClick={this.onSave}>Save</Button>
                    </Col>
                    <Col xs={6} md={6}>
