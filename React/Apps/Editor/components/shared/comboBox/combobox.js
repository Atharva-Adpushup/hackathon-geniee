...
module.exports = React.createClass({
  ...
  */
	...
	handleInputBlur: function() {
		typeof this.props.onBlur == 'function' ? this.props.onBlur() : null;
  ...
  */
	...
	handleOptionMouseEnter: function(index) {
		if (this.state.usingKeyboard) this.setState({ usingKeyboard: false });
		else this.focusOptionAtIndex(index);
	},
	...
	render: function() {
		return (
			<div className={this.getClassName()}>
				...
				/>
				<span aria-hidden="true" className="rf-combobox-button" onClick={this.handleButtonClick} />
				<div
