            ...
            <div className="containerButtonBar sm-pad">
                <Accordion defaultActiveKey="1">
                    <Panel header="Left Margin" eventKey="1">
                        <CustomCssEditor labelText="Left" name="leftMargin" value={this.state.leftMargin} onValueChange={this.onChange.bind(null, "leftMargin")} />
                    </Panel>

                    <Panel header="Center Margin" eventKey="2">
                        <CustomCssEditor labelText="Center" name="noneMargin" value={this.state.noneMargin} onValueChange={this.onChange.bind(null, "noneMargin")} />
                    </Panel>

                    <Panel header="Right Margin" eventKey="3">
                        <CustomCssEditor labelText="Right" name="rightMargin" value={this.state.rightMargin} onValueChange={this.onChange.bind(null, "rightMargin")} />
                    </Panel>
                </Accordion>

                <Row className="butttonsRow">
                    <Col xs={6} md={6}>
                        <Button disabled={!this.state.currentMargin} className="btn-lightBg btn-save" onClick={this.onSave} >Save</Button>
                    </Col>
                    <Col xs={6} md={6}>
