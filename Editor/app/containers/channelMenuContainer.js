...
import { getAllChannels, getActiveChannel } from 'selectors/channelSelectors';
...
const mapStateToProps = (state) => {
		...
		return { ...json, channel: getActiveChannel(state), partner: getPartner(state), allChannels: getAllChannels(state) };
	},
