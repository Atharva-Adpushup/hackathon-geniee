...
const platformSelector = ({ selectors, onHighlightElement, onSelectElement, channelId }) => {
	return (<div className="SelectParent">
		{
			selectors.map((selector, index) => (
				<Row key={index} onMouseOut={onHighlightElement.bind(null, selectors[0].xpath, channelId)}
					onMouseOver={onHighlightElement.bind(null, selector.xpath, channelId)} onClick={onSelectElement.bind(null, selector.xpath, channelId)}
    >
