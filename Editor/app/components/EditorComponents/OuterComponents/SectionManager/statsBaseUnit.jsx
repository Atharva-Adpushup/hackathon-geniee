    ...
    render: function () {
        return(
            <Row onClick={this.toggleExpansion} className={this.state.isExpanded ? "expanded":"collapsed"}>
                ...
                <Col xs={1}>{this.props.data.clicks ? ((this.props.data.clicks/this.props.data.impressions)*100).toPrecision(4) : 0}</Col>
                <Col xs={2}>{this.props.data.xpathMiss}</Col>
                <Col xs={2}>{this.props.data.ActiveViews ? ((this.props.data.ActiveViews/this.props.data.impressions)*100).toPrecision(4) : "N/A"}</Col>
                {this.state.isExpanded ? this.props.component : (this.props.component ?
