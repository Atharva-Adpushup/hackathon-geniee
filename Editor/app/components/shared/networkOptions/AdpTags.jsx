...
const AdpTags = (props) => {
	...
	let priceFloor, isHeaderBiddingActivated = headerBiddingFlag;
	...
	return (
		<div className="mB-10 mT-10">
			<Row>
				<Col xs={6}><strong>Price Floor</strong></Col>
				<Col xs={6}>
					<input type="text" placeholder="Enter Price Floor" className="inputBasic mB-10" ref={ el => priceFloor = el } defaultValue={priceFloorFromProps} />
				</Col>
			</Row>
			<Row>
				<Col xs={8} style={{margin: "0 auto", width: "100%"}}>
					<CustomToggleSwitch labelText="Header Bidding" className="mB-10" defaultLayout checked={headerBiddingFlag} name="headerBiddingSwitch" onChange={switchChangeHandler} layout="horizontal" size="m" id="js-header-bidding-switch" on="Yes" off="No" />
				</Col>
			</Row>
			{
				showButtons ? (
