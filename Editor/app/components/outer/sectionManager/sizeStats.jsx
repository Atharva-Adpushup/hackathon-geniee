...
module.exports = React.createClass({
    ...
    getChildren: function () {
        return (<div className="level-og">
            {
                _(this.props.data.variations).map(function (variation) {
                    return (<BaseUnit name={variation.variationName} data={{impressions:variation.impressions,clicks:variation.clicks,xpathMiss:variation.xpathMiss}}/>)
                }.bind(this))
            }
        </div>)
    },
