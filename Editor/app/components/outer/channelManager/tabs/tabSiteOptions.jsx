...
const showSiteModesPopover = (props, ev) => {
	...
	EditorModes = (props) => (
		<div className="modes">
			<input onChange={props.toggleEditorMode} type="radio" className="modes-input" name="editorMode" value="editor" id="editormode" defaultChecked />
			<OverlayTrigger placement="bottom" overlay={<Tooltip id="editorModeTooltip">Editor Mode</Tooltip>}>
				<label htmlFor="editormode" className="modes-label modes-label-off"><i className="fa fa-code" /></label>
			</OverlayTrigger>

			<input onChange={props.toggleEditorMode} type="radio" className="modes-input" name="editorMode" value="browse" id="browsemode" />
			<OverlayTrigger placement="bottom" overlay={<Tooltip id="browseModeTooltip">Browse Mode</Tooltip>}>
				<label htmlFor="browsemode" className="modes-label modes-label-on"><i className="fa fa-globe" /></label>
			</OverlayTrigger>
