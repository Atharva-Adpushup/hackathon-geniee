...
module.exports = React.createClass({
	...
	saveSection () {
	let name = $(React.findDOMNode(this.refs.section)).find('input').val();
	if (name) {
	let sec = this.props.flux.store(CommonConsts.enums.stores.SECTION_STORE).getChannelSectionByName(this.props.section.channelId, name);
	if (!sec) {
	...
	return (<div className="containerButtonBar contextEditMenu">
                ...
                !this.state.editSection ? (
                    	<Row>
                        	...
                        	<Col xs={2} className="pd-10"><i className="fa fa-pencil-square-o" onClick={this.toggleSectionEdit} /></Col>
                    </Row>
                ) : (
                        	<Row>
                            	...
                            	<Col xs={12} className="pd-10"><Button className="btn-lightBg btn-Small btn-save" onClick={this.saveSection} /></Col>
                        </Row>
                    )
            }
            	{
                !this.state.editXpath ? (
                    	<Row>
                        	...
                        	<Col xs={2} className="pd-10"><i className="fa fa-pencil-square-o" onClick={this.toggleXpathEdit} /></Col>
                    </Row>
                ) : (
                        	<Row>
                            	...
                            	<Col xs={12} className="pd-10"><Button className="btn-lightBg btn-Small btn-save" onClick={this.saveXpath} /></Col>
                        </Row>
                    )
            }
            	<Row>
