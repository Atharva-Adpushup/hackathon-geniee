...
function getOauth2Client() {
	...
	return oauth2Client.refreshAccessTokenAsync().then(function(newCreds) {
	...
	getReport: function(cf) {
		return getOauth2Client()
			...
			.then(function(finalConfig) {
				return adxReports.generateAsync(finalConfig).then(function(data) {
